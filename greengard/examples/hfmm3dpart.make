...
MODSUF=mod
FC=ifort -c
FFLAGS= -xHOST -O3 -ip -openmp 
FLINK=ifort -o $(PROJECT) -xHOST -O3 -ip -openmp -static
WITH_SECOND=1
...
FC=ifort -c
FFLAGS=-xHOST -O3 -ip
FLINK=ifort -o $(PROJECT) -xHOST -O3 -ip
WITH_SECOND=1
...
MODSUF=mod
FC=ifort -c
FFLAGS=-xHOST -O3 -ip -p
FLINK=ifort -o $(PROJECT) -xHOST -O3 -ip -p 
WITH_SECOND=1
...
MODSUF=mod
FC=ifort -c
FFLAGS=-xHOST -O3 -ip -mcmodel medium -i-dynamic 
FLINK=ifort -o $(PROJECT) -xHOST -O3 -ip -mcmodel medium -i-dynamic 
