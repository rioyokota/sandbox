...
struct DerivativeTerm {
  ...
  static inline real kernel(const real *C, const real *dist) {
...
struct DerivativeTerm<n,kx,ky,kz,-1> {
  ...
  static inline real kernel(const real *C, const real*) {
...
struct DerivativeSum {
  ...
  static inline real loop(const real *C, const real *dist) {
...
struct DerivativeSum<nx,ny,nz,kx,ky,kz,0> {
  static inline real loop(const real*, const real*) {
    return 0;
  }
};
...
template<>
struct Terms<0,0,0> {
  static inline void power(real*, const real*) {}
  static inline void derivative(real*, const real*, const real&) {}
  static inline void scale(real*) {}
};
...
struct M2LSum {
  static inline real kernel(const real *L, const real *M) {
...
template<int nx, int ny, int nz>
struct Downward {
  static inline void M2L(real *L, const real *C, const real *M) {
  ...
  static inline void L2P(real *TRG, const real *C, const real *L) {
    Downward<nx,ny+1,nz-1>::L2P(TRG,C,L);
...
struct Downward<nx,ny,0> {
  ...
  static inline void L2P(real *TRG, const real *C, const real *L) {
    Downward<nx+1,0,ny-1>::L2P(TRG,C,L);
...
struct Downward<0,0,0> {
  ...
  static inline void L2P(real*, const real*, const real*) {}
};

template<int PP>
inline void getCoef(real *C, const real *dist, real &invR2, const real &invR) {
  C[0] = invR;
...
template<>
inline void getCoef<1>(real *C, const real *dist, real &invR2, const real &invR) {
  C[0] = invR;
  invR2 = -invR2;
...
template<>
inline void getCoef<2>(real *C, const real *dist, real &invR2, const real &invR) {
...
template<>
inline void getCoef<3>(real *C, const real *dist, real &invR2, const real &invR) {
...
template<>
inline void getCoef<4>(real *C, const real *dist, real &invR2, const real &invR) {
...
template<>
inline void getCoef<5>(real *C, const real *dist, real &invR2, const real &invR) {
...
template<>
inline void getCoef<6>(real *C, const real *dist, real &invR2, const real &invR) {
...
template<int PP>
inline void sumM2L(real *L, const real *C, const real *M) {
  for_l L[l] += M[0] * C[l];
...
template<>
inline void sumM2L<1>(real *L, const real *C, const real *M) {
  for_l L[l] += M[0] * C[l];
}

template<>
inline void sumM2L<2>(real *L, const real *C, const real *M) {
  sumM2L<1>(L,C,M);
...
template<>
inline void sumM2L<3>(real *L, const real *C, const real *M) {
  sumM2L<2>(L,C,M);
...
template<>
inline void sumM2L<4>(real *L, const real *C, const real *M) {
  sumM2L<3>(L,C,M);
...
template<>
inline void sumM2L<5>(real *L, const real *C, const real *M) {
  sumM2L<4>(L,C,M);
...
template<>
inline void sumM2L<6>(real *L, const real *C, const real *M) {
  sumM2L<5>(L,C,M);
      ...
      for( jx[2]=jxmin[2]; jx[2]<jxmax[2]; jx[2]++ ) {
        for( jx[1]=jxmin[1]; jx[1]<jxmax[1]; jx[1]++ ) {
          for( jx[0]=jxmin[0]; jx[0]<jxmax[0]; jx[0]++ ) {
            ...
            for_3d jxp[d] = (jx[d] + nunitGlob[d]) / nunitGlob[d];
            for_3d periodic[d] = (jxp[d] - 1) * 2 * R0;
            P2P(Leafs[i][0],Leafs[i][1],Leafs[j][0],Leafs[j][1],periodic);
            NP2P++;
          }
        }
      }
...
#pragma omp parallel for schedule(static, 8)
      for( int i=0; i<(1 << 3 * lev); i++ ) {
        ...
        Upward<0,0,P-1>::M2M(Multipole[p],C,M);
      }
    }
  }
...
#pragma omp parallel for
      for( int i=0; i<(1 << 3 * lev); i++ ) {
        ...
        Downward<0,0,P>::L2L(Local[c],C,Local[p]);
      }
    }
  }
...
#pragma omp parallel for
    for( int i=0; i<numLeafs; i++ ) {
      ...
      for( int j=Leafs[i][0]; j<Leafs[i][1]; j++ ) {
        ...
        Downward<0,0,1>::L2P(Ibodies[j],C,L);
      }
    }
  }

public:
  Kernel() : NM2L(0), NP2P(0) {}
  ~Kernel() {
